...
sendOnWhatsApp=() => {
  ...
  Linking.openURL("whatsapp://send?text=Hello!! I Want to Make an Appointment. My name is " + field1.value() +"and my age is " + field2.value() +"&phone=+91"+doctorObject.contact);  
  }
  else{
        ...
        <SafeAreaView>
          <ScrollView>
            ...
            <Text style={{ fontSize: 25, margin: 10 }}>
              ...
              <View style={{backgroundColor: "#fff", margin: 13, borderRadius: 35, padding: 10, paddingTop: 20}}>
            ...
            <View style={{margin: 35, marginTop: 10, maxHeight: 40}}>
              <Button onPress={this.sendOnWhatsApp} title = 'Make WhatsApp Appointment' type='outline' buttonStyle={{
                borderColor:"green", borderWidth: 2, borderRadius:15 }} titleStyle={{color: "green"}} icon={
                  <SocialIcon type='whatsapp' light raised={false}/>}/>
              </View>
              </View>
